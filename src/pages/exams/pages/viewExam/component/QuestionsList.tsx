    ...
    <React.Fragment>
      <ul className="p-0 flex gap-3">
        {(["English", "Tamil"] as const).map((item) => (
          <li
            key={item}
            className={`border py-2 px-4 rounded-xl text-[12px] cursor-pointer ${
              language === item
        ...
        {questions?.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {q.answer && (
                <p className="bg-[#D0FFEA] mb-2 p-2 rounded-lg text-[14px] w-[50%]">
                  Answer:{" "}
              ...
              <p className="bg-[#FFF8DA] p-2 rounded-lg text-[14px] inline-block">
